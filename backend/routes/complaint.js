          ...
          <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e1e1e1; border-radius: 10px; background-color: #ffffff;">
            ...
            <div style="padding: 20px;">
              ...
              <p style="color: #7f8c8d; font-size: 16px; line-height: 1.5;">
                Thank you for reaching out to us! Our experienced specialists are already working on resolving your issue. You can expect a detailed reply to your query within 24 hours. We complaintRouterreciate your patience and understanding.
              </p>
            </div>
...
complaintRouter.post("/post-complaints", async (req, res) => {
  try {
...
complaintRouter.get("/get-complaints", async (req, res) => {
  try {
...
complaintRouter.put("/update-complaint-status", async (req, res) => {
  try {
